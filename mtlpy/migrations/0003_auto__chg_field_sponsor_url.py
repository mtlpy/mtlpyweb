...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sponsor.url'
        db.alter_column(u'mtlpy_sponsor', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Sponsor.url'
        raise RuntimeError("Cannot reverse this migration. 'Sponsor.url' and its values cannot be restored.")
