...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for sponsor in orm['mtlpy.Sponsor'].objects.filter(name__in=[
                u"iWeb", u"Ludia", u"Brasserie Benelux", u"Savoir-faire Linux",
                u"UQÀM", u"Outbox", u"Caravan"]):
            sponsor.frontpage = True
            sponsor.save()
