...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mtlpy_sponsor', 'description_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Sponsor.description_fr'
        db.add_column(u'mtlpy_sponsor', 'description_fr',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'mtlpy_sponsor', 'description_en')

        # Deleting field 'Sponsor.description_fr'
        db.delete_column(u'mtlpy_sponsor', 'description_fr')
    ...
    models = {
        ...
        u'mtlpy.eventsponsor': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'event_sponsors'", 'null': 'True', 'to': u"orm['blog.Post']"}),
