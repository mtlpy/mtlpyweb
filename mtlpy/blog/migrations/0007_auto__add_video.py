...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_video', (
            ...
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'videos', to=orm['blog.Post'])),
            ('title_en', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('title_fr', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
    ...
    models = {
        ...
        u'blog.video': {
            'Meta': {'ordering': "(u'post',)", 'object_name': 'Video'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'videos'", 'to': u"orm['blog.Post']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '256'}),
            'title_en': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'title_fr': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
