...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_post', 'logo',
                      self.gf('sorl.thumbnail.fields.ImageField')(default='default.jpg', max_length=100),
                      keep_default=False)

        # Adding field 'Category.logo'
        db.add_column('blog_categories', 'logo',
                      self.gf('sorl.thumbnail.fields.ImageField')(default='default.jpg', max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('blog_post', 'logo')

        # Deleting field 'Category.logo'
        db.delete_column('blog_categories', 'logo')
    ...
    models = {
        ...
        u'blog.category': {
            'Meta': {'ordering': "('slug',)", 'object_name': 'Category', 'db_table': "'blog_categories'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('sorl.thumbnail.fields.ImageField', [], {'default': "'default.jpg'", 'max_length': '100'}),
