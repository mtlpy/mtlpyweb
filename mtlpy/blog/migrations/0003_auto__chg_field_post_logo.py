...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.logo'
        db.alter_column('blog_post', 'logo', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Post.logo'
        db.alter_column('blog_post', 'logo', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'blog.category': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('sorl.thumbnail.fields.ImageField', [], {'default': "'category/default.jpg'", 'max_length': '100'}),
