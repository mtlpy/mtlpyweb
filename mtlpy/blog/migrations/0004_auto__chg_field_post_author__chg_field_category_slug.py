...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blog_post', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.MtlPyUser']))

        # Changing field 'Category.slug'
        db.alter_column(u'blog_categories', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Post.author'
        db.alter_column(u'blog_post', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Category.slug'
        db.alter_column(u'blog_categories', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=256))
